...
const benefits = [
  {
    ...
    icon: <img src="/plan.svg" alt="Plan" style={{ width: '100px', height: '100px' }} />,
    items: [
      'Конкретные действия',
  ...
  },
  {
    ...
    icon: <img src="/podbor.svg" alt="Selection" style={{ width: '134px', height: '134px' }} />,
    items: []
  },
  {
    title: 'Подготовим к сеансу с психологом и психиатром',
    subtitle: 'Поможем максимально эффективно использовать время',
    icon: <img src="/podgot.svg" alt="Preparation" style={{ width: '100px', height: '100px' }} />,
    items: [
  ...
  },
  {
    ...
    icon: <img src="/file.svg" alt="PDF" style={{ width: '100px', height: '100px' }} />,
    items: [
