...
export const mbiTest: TestConfig = {
  ...
  description: 'Инструмент для оценки уровня профессионального выгорания по трём шкалам: эмоциональное истощение, деперсонализация и редукция профессиональных достижений.',
  scoringStrategy: 'sum',
  questions: [
    // Эмоциональное истощение (1-9)
    { id: 1, text: 'Я чувствую себя эмоционально опустошённым своей работой.', type: 'single', options: frequencyOptions },
    ...
    { id: 8, text: 'Я чувствую себя выгоревшим из-за работы.', type: 'single', options: frequencyOptions },
    ...
    { id: 10, text: 'Я стал более бессердечным к людям с тех пор, как устроился на эту работу.', type: 'single', options: frequencyOptions },
    { id: 11, text: 'Я беспокоюсь, что эта работа делает меня эмоционально чёрствым.', type: 'single', options: frequencyOptions },
    { id: 12, text: 'Я чувствую себя очень энергичным.', type: 'single', options: frequencyOptions },
    ...
    { id: 19, text: 'Я достиг многого ценного в этой работе.', type: 'single', options: frequencyOptions },
