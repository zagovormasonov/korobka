...
// Список всех дополнительных тестов
...
// Функция для получения конфигурации теста по ID или названию
export const getTestConfig = (idOrName: string): TestConfig | undefined => {
...
// Реэкспорт типов
export type { TestConfig, TestQuestion, TestOption, TestInterpretation, TestSource } from './types';
