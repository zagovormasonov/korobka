...
export const pdq4Test: TestConfig = {
  ...
  description: 'Опросник для скрининга симптомов ПРЛ по критериям DSM-IV.',
  scoringStrategy: 'sum',
  questions: [
    { id: 1, text: 'Я часто предпринимаю отчаянные попытки избежать реального или воображаемого одиночества.', type: 'single', options: [{ value: 1, label: 'Да' }, { value: 0, label: 'Нет' }] },
    ...
    { id: 4, text: 'У меня часто меняется представление о себе, своих целях или ценностях.', type: 'single', options: [{ value: 1, label: 'Да' }, { value: 0, label: 'Нет' }] },
