...
export const asrsTest: TestConfig = {
  ...
  description: 'Скрининговый инструмент для выявления синдрома дефицита внимания и гиперактивности у взрослых. Отвечайте, основываясь на вашем опыте за последние 6 месяцев.',
  scoringStrategy: 'sum',
  questions: [
