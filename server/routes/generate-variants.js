...
Твоя задача — сформулировать 3 варианта краткого, профессионального, но понятного описания его состояния (будто ты помогаешь ему сформулировать запрос).
Верни СТРОГО массив JSON из 3 строк. Без маркдауна, без форматирования, только валидный JSON-массив.
Пример: ["Чувствую постоянную усталость и апатию", "Испытываю сильную тревогу по вечерам", "Не могу сосредоточиться на рабочих задачах"]`;
