...
1. Каждая цель ДОЛЖНА быть НАПРЯМУЮ связана с описанной ситуацией.
...
3. Перед генерацией мысленно спроси: «Если пользователь прочитает эту цель,
   скажет ли он: это точно про мою ситуацию?». Если нет — замени.
...
4. ОТ 3 ДО 7 БЛОКОВ НА КАЖДЫЙ ШАГ. Это критически важно: минимум 3 блока, максимум 7.
...
9. «СВОЙ ВАРИАНТ» — TEXT_INPUT ПОСЛЕ БЛОКОВ ВЫБОРА:
...
10. shortDescription упражнений: НЕ ставь точку в конце.

11. ПОЛЬЗОВАТЕЛЬСКИЕ ЦЕЛИ (goalsText): если в поле goalsText указаны цели пользователя
