...
ВЕРНИ СТРОГО JSON:
{
  "intro": "Markdown-текст. Вводная часть, объясняющая, как пользоваться аптечкой, ключевые трудности, простую рутину, направление психотерапии и напутствие (разделы 1, 2, 4, 5, 6 из структуры ниже).",
  "exercises": [
    {
      "name": "Название техники (только на русском, без английских терминов)",
      "duration": "Время выполнения (например: 3-5 минут)",
      "therapyType": "Вид терапии (СТРОГО одно из: КПТ, ДБТ, ТПО, ТСС, Схема-терапия. Максимум 15 символов!)",
      "purpose": "Для чего (1 предложение)",
      "steps": ["Шаг 1", "Шаг 2"],
      "source": "Откуда это (Это базовая техника из...)"
    }
  ]
}
...
## 3. Индивидуальный набор техник (ПОМЕСТИТЬ В МАССИВ EXERCISES)
...
- **Название техники:** (Только на русском, без английских или переведенных с английского терминов. Используйте только устоявшиеся термины из официальных русскоязычных источников по психотерапии. Исключение: английские аббревиатуры вроде ACT, DBT, CFT разрешены ТОЛЬКО при упоминании названия самого метода терапии, но не в названии упражнения)
- **Время выполнения:** (Например: "3-5 минут")
- **Вид терапии:** (СТРОГО ОДНА ФРАЗА ИЛИ АББРЕВИАТУРА ИЗ СПИСКА: КПТ, ДБТ, ТПО, ТСС, Схема-терапия. Лимит: максимум 15 символов, больше никаких слов в этой строке!)
