...
- НИКОГДА не задавай вопросов. Это единоразовая обратная связь, а не диалог. Пользователь не сможет ответить. Вместо вопросов используй утверждения и рекомендации.
