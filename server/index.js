...
- draft_nudge (когда hasDraft=true): пользователь уже начал заполнять заметку сегодня. Если есть его частичные ответы — дай мини-инсайт по уже заполненным данным (свяжи с диагностикой или целями). Если ответов нет — дай полезное наблюдение по данным диагностики или целям, мотивирующее завершить. Пообещай конкретную обратную связь: «после завершения я смогу показать, как X связано с Y в вашем случае». НЕ упоминай, что заметка не завершена. Просто дай ценность и органично подведи к завершению. buttonText — «Продолжить», «Завершить» или подобное.
